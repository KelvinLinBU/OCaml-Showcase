...
# 15 "lib/parser/par.ml"
    ...
    | OR
    | NUM of (
# 14 "lib/parser/par.mly"
       (int)
# 27 "lib/parser/par.ml"
  )
    | NEQ
    | MUL
    | MOD
...
# 2 "lib/parser/par.mly"
  
  open Utils

# 58 "lib/parser/par.ml"
...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState55 : (('s, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_VAR, _menhir_box_prog) _menhir_state
    (** State 55.
        Stack shape : LET VAR.
        Start symbol: prog. *)

  | MenhirState57 : ((('s, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_VAR, _menhir_box_prog) _menhir_cell1_expr, _menhir_box_prog) _menhir_state
    (** State 57.
        Stack shape : LET VAR expr.
        Start symbol: prog. *)
...
# 93 "lib/parser/par.mly"
         ( Unit )
# 274 "lib/parser/par.ml"
     : (Utils.prog))

let _menhir_action_09 =
  fun _1 _3 ->
    (
# 59 "lib/parser/par.mly"
                               (Bop(Add, _1, _3))
# 282 "lib/parser/par.ml"
     : (Utils.prog))
...
# 61 "lib/parser/par.mly"
                              ( Bop (Lte, _1, _3) )
# 298 "lib/parser/par.ml"
     : (Utils.prog))

let _menhir_action_12 =
  fun _1 _3 ->
    (
# 63 "lib/parser/par.mly"
                             ( Bop (Gt, _1, _3) )
# 306 "lib/parser/par.ml"
     : (Utils.prog))
...
# 65 "lib/parser/par.mly"
                              ( Bop(Gte, _1, _3))
# 314 "lib/parser/par.ml"
     : (Utils.prog))

let _menhir_action_14 =
  fun _1 _3 ->
    (
# 67 "lib/parser/par.mly"
                             ( Bop (Eq, _1, _3) )
# 322 "lib/parser/par.ml"
     : (Utils.prog))
...
# 45 "lib/parser/par.mly"
                              ( Let(_3, App (Fun (_3, _5), Var _3), _7) )
...
let _menhir_action_26 =
  fun _2 _4 ->
    (
# 48 "lib/parser/par.mly"
                     (Fun(_2, _4) )
# 418 "lib/parser/par.ml"
     : (Utils.prog))

let _menhir_action_27 =
  fun _2 _4 _6 ->
    (
# 49 "lib/parser/par.mly"
                              (If(_2, _4, _6))
# 426 "lib/parser/par.ml"
     : (Utils.prog))
...
include struct
  ...
  and _menhir_run_58 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_VAR, _menhir_box_prog) _menhir_cell1_expr -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      ...
      let _7 = _v in
      let _v = _menhir_action_24 _3 _5 _7 in
      _menhir_goto_expr _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_run_56 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_LET _menhir_cell0_VAR as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
